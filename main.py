# Задача 34: Винни-Пух попросил Вас посмотреть, есть ли в его стихах ритм. Поскольку разобратьс
...
vowel = ["а", "о", "у", "и", "я", "е", "ё", "ю", "ы"]

x = input("Введите слово/фразу: ")
...
if count % 2 == 0: print("Парам пам-пам")
